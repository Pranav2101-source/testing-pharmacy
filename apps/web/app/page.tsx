          ...
          >
            <div className="px-5 py-4 flex flex-col gap-1">
              ...
              <div className="flex gap-2 mt-3">
                <Link href="/login" className="flex-1 text-center py-2.5 rounded-xl border border-slate-200 text-sm font-semibold text-slate-700">
                  Sign in
                </Link>
                <Link href="/register" className="flex-1 text-center py-2.5 rounded-xl bg-brand-600 text-white text-sm font-bold">
                  Start Free
                </Link>
              </div>
            </div>
