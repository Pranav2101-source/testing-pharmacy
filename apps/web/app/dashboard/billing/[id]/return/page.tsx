  ...
  if (fetchError || !invoice) {
    return (
      <div className="flex flex-col h-full items-center justify-center bg-white gap-3">
        ...
        <Link href="/dashboard/billing" className="text-blue-600 text-[13px] hover:underline flex items-center gap-1">
  ...
  if (invoice.isCancelled || invoice.status === "CANCELLED") {
    return (
      <div className="flex flex-col h-full items-center justify-center bg-white gap-3">
        ...
        <Link href={`/dashboard/billing/${id}`} className="text-blue-600 text-[13px] hover:underline flex items-center gap-1">
      ...
      <div className="flex flex-col h-full items-center justify-center bg-white gap-5">
        ...
        >
          ...
          <div className="flex gap-3 mt-2">
            <Link href="/dashboard/billing/returns"
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 h-[52px] bg-white border-b border-slate-200 flex-shrink-0 sticky top-0 z-10">
        <div className="flex items-center gap-2">
          <Link href={`/dashboard/billing/${id}`} className="flex items-center gap-1.5 text-[13px] text-slate-500 hover:text-slate-700 transition-colors">
