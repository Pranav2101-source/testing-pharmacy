...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // TODO: wire up to POST /api/auth/forgot-password when backend endpoint is added
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 }}
              ...
              {[
                ...
                <div key={step} className="flex items-center gap-3">
                  <span className="w-6 h-6 rounded-full bg-brand-100 text-brand-600 text-[11px] font-black flex items-center justify-center flex-shrink-0">
                    {i + 1}
                  </span>
