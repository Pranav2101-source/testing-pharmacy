            ...
            <div className="col-span-3 bg-white rounded border border-slate-100 p-1.5 shadow-sm">
              ...
              <div className="relative h-14">
                <svg viewBox="0 0 140 42" className="w-full h-full" preserveAspectRatio="none">
                  ...
                  <polygon points="0,40 0,36 12,31 24,34 36,26 48,20 60,23 72,15 84,13 96,9 108,7 120,5 132,3 140,1 140,40" fill="url(#cg)" />
                  <polyline points="0,36 12,31 24,34 36,26 48,20 60,23 72,15 84,13 96,9 108,7 120,5 132,3 140,1" fill="none" stroke="#3b82f6" strokeWidth="1.4" strokeLinejoin="round" />
