    ...
    <div className="flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 border-b border-slate-200 flex-shrink-0" style={{ height: "52px" }}>
        <div className="flex items-center gap-3">
          <Link to="/dashboard/billing" className="flex items-center gap-1.5 text-slate-500 hover:text-slate-700 text-[13px] transition-colors">
            ...
            {loading ? (
              ...
              displayed.map((row) => {
                ...
                return (
                  <tr
                    key={row.id}
                    onClick={() => navigate(`/dashboard/billing/${row.invoice.id}`)}
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-[13px] font-medium text-blue-600 whitespace-nowrap">
                      <Link
                        to={`/dashboard/billing/${row.invoice.id}`}
